...
*/
    ...
    */
    ...
    async getDataTeam1() {
        try {
            const response = await fetch('http://localhost:1214/team1');
            const data = await response.json();
            const equipa1 = { nome: 'Equipa 1', jogadores: data };
            this.setState({
                loaded: true,
                equipa1
            });
    ...
    async getDataTeam2() {
        try {
            const response = await fetch('http://localhost:1214/team2');
            const data = await response.json();
            const equipa2 = { nome: 'Equipa 2', jogadores: data };
            this.setState({
                loaded: true,
                equipa2
            });
